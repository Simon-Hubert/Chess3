...
public class RenfortPiece : MonoBehaviour
{
    ...
    {
        visual.transform.localPosition = new Vector2(visual.transform.localPosition.x, - l) ; // 1 �tant la hauteur d'une tile
    ...
    {
        visual.transform.localPosition = new Vector2( - l, visual.transform.localPosition.y); // 1 �tant la hauteur d'une tile
